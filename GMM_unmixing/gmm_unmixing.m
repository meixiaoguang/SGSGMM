function [A,R,w_jk,mu_jk,sigma_jk,extra,beta1,beta2] = gmm_unmixing(I, options,endmembers,I_org,Results_segment, num_segment)
...
options = insert_param_when_absent(options, 'show_fig', 1);
...
[A,R,w_jk,mu_jk,sigma_jk,extra] = gmm(I,M,options,I_org,Results_segment,num_segment);
